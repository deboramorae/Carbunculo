...
extension CGSize {
    public struct sizeNode {
        ...
        public static let floorMystic2: CGSize = CGSize.sizeProportinalWithFrame(size: CGSize(width: 1478, height: 62))
        ...
        public static let choiceButtonMistic : CGSize = CGSize.sizeProportinalWithFrame(size: CGSize(width: 319, height: 41))
        ...
        public static let macacoSave :  CGSize = CGSize.sizeProportinalWithFrame(size: CGSize(width: 78, height: 81))
        
        public static let coracaoNode :  CGSize = CGSize.sizeProportinalWithFrame(size: CGSize(width: 20, height: 22))
        
        public static let carbunculoNode :  CGSize = CGSize.sizeProportinalWithFrame(size: CGSize(width: 136, height: 131))
