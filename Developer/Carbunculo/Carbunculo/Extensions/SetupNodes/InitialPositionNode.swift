...
extension CGPoint {
    public struct initialPositionNode {
        ...
        public static let playerNode: CGPoint = CGPoint.positionProportionalWithFrame(position: CGPoint(x: (-SKViewSizeRect.width / 2), y: -200))
        ...
        public static let carbunculoNode: CGPoint = CGPoint.positionProportionalWithFrame(position: CGPoint(x: 9540, y: -10))
        
         public static let coracaoMacacoNode: CGPoint =  CGPoint.positionProportionalWithFrame(position: CGPoint(x: 2330, y: -50))
        ...
        public static let maracujaMacaco: CGPoint = CGPoint.positionProportionalWithFrame(position: CGPoint(x: 2330, y: 0))
