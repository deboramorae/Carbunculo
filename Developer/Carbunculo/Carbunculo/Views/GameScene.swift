...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        do {
            ...
            let choice = ChoicesEntity(entityManager: entityManager, scene: self,textureDecisao: SKTexture.imageNamed.decisao1, textureButton1: SKTexture.imageNamed.escolha2, textureButton2: SKTexture.imageNamed.escolha1, position: CGPoint.initialPositionNode.choiseHUDNode, numberChoice: 1, sizeButton1: CGSize.sizeNode.choiseButtonNode)
            
            let choice2 = ChoicesEntity(entityManager: entityManager, scene: self,textureDecisao: SKTexture.imageNamed.decisao2, textureButton1: SKTexture.imageNamed.escolha4, textureButton2: SKTexture.imageNamed.escolha3, position: CGPoint.initialPositionNode.choiseHUDNode2, numberChoice: 2, sizeButton1: CGSize.sizeNode.choiseButtonNode)
            
            let choice3 = ChoicesEntity(entityManager: entityManager, scene: self, textureDecisao: SKTexture.imageNamed.decisao3, textureButton1: SKTexture.imageNamed.escolha5, textureButton2: SKTexture.imageNamed.escolha6, position: CGPoint.initialPositionNode.choiseHUDNode3, numberChoice: 3, sizeButton1: CGSize.sizeNode.choiceButtonMistic)
