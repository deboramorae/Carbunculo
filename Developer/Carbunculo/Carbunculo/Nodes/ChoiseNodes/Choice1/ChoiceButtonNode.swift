...
class ChoiceButtonNode: SKNode {
    ...
    init(backgroundNamed: SKTexture, size: CGSize, action: @escaping  () -> Void = {}) {
        
        self.backgroundNode = SKSpriteNode(texture: backgroundNamed, color: .clear, size: size)
        ...
        self.backgroundNode = SKSpriteNode.init(texture: backgroundNamed , size: size)
